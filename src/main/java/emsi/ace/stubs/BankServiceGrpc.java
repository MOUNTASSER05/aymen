...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest,
      emsi.ace.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = emsi.ace.stubs.Bank.ConvertCurrencyRequest.class,
      responseType = emsi.ace.stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest,
      emsi.ace.stubs.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest, emsi.ace.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<emsi.ace.stubs.Bank.ConvertCurrencyRequest, emsi.ace.stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  emsi.ace.stubs.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  emsi.ace.stubs.Bank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest,
      emsi.ace.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest,
      emsi.ace.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod() {
    io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest, emsi.ace.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest,
      emsi.ace.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest,
      emsi.ace.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest, emsi.ace.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest,
      emsi.ace.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest,
      emsi.ace.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<emsi.ace.stubs.Bank.ConvertCurrencyRequest, emsi.ace.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(emsi.ace.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getStream(emsi.ace.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void performStream(emsi.ace.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getPerformStreamMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyRequest> fullCurrencyStream(
        io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                emsi.ace.stubs.Bank.ConvertCurrencyRequest,
                emsi.ace.stubs.Bank.ConvertCurrencyResponse>(
  ...
  public static final class BankServiceStub extends io.grpc.stub.AbstractStub<BankServiceStub> {
    ...
    public void performStream(emsi.ace.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getPerformStreamMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public emsi.ace.stubs.Bank.ConvertCurrencyResponse convert(emsi.ace.stubs.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<emsi.ace.stubs.Bank.ConvertCurrencyResponse> getStream(
        emsi.ace.stubs.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public emsi.ace.stubs.Bank.ConvertCurrencyResponse performStream(emsi.ace.stubs.Bank.ConvertCurrencyRequest request) {
      return blockingUnaryCall(
          getChannel(), getPerformStreamMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<emsi.ace.stubs.Bank.ConvertCurrencyResponse> convert(
        emsi.ace.stubs.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<emsi.ace.stubs.Bank.ConvertCurrencyResponse> performStream(
        emsi.ace.stubs.Bank.ConvertCurrencyRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getPerformStreamMethod(), getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((emsi.ace.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_STREAM:
          serviceImpl.getStream((emsi.ace.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_PERFORM_STREAM:
          serviceImpl.performStream((emsi.ace.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<emsi.ace.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return emsi.ace.stubs.Bank.getDescriptor();
    }
